...
func (x *NewsRequest) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *ChangeNewsResponse) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_news_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x22, 0x14, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0e, 0x22, 0x09, 0x2f, 0x6e, 0x65, 0x77,
	0x73, 0x2f, 0x61, 0x64, 0x64, 0x3a, 0x01, 0x2a, 0x12, 0x4e, 0x0a, 0x07, 0x44, 0x65, 0x6c, 0x4e,
