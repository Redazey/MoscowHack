...
const (
	NewsService_News_FullMethodName = "/news.NewsService/News"
)
...
func (c *newsServiceClient) News(ctx context.Context, in *NewsRequest, opts ...grpc.CallOption) (*NewsResponse, error) {
	...
	err := c.cc.Invoke(ctx, NewsService_News_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _NewsService_News_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NewsService_News_FullMethodName,
	}
